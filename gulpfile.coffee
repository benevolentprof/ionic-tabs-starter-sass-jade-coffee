...
gulp.task 'index', ->
  ...
  blocks = gulp.src ['./www/blocks/router/*.module.js', './www/blocks/router/*.js', './www/blocks/logger/*.module.js', './www/blocks/logger/*.js', './www/blocks/exception/*.module.js', './www/blocks/exception/*.js'], read: false
